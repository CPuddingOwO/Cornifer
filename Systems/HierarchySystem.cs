...
public static class HierarchySystem {
    ...
    public static void SetParent(Entity? parent, Entity child, Vector2? source = null, Vector2? target = null) {
        ...
        // 默认连线位置为贴图中心
        childHier.SourceOffset =
            source ?? new Vector2(parentVisual.Texture.Width / 2f, -parentVisual.Texture.Height / 2f);
        childHier.TargetOffset =
            target ?? new Vector2(childVisual.Texture.Width / 2f, -childVisual.Texture.Height / 2f);
