...
namespace Cornifer
{
    public static class StaticData
    {
		...
		public static readonly List<string> PlacedObjectTypes = new()
        {
            ...
            "HRGuard","DevToken","LightSource","FlareBomb","PuffBall","GraffitiBomb","TempleGuard","LightFixture","DangleFruit",
        ...
        public static readonly Dictionary<string, List<string>> SlugcatRegionAvailability = new()
        {
			...
			["Watcher"] = new() { "SU", "HI", "CC", "SH", "LF", "SB", "WARA", "WARB", "WARC", "WARD", "WARE", "WARF", "WARG", "WAUA", "WBLA", "WDSR", "WGWR", "WHIR", "WORA", "WPTA", "WRFA", "WRFB", "WRRA", "WRSA", "WSKA", "WSKB", "WSKC", "WSKD", "WSSR", "WSUR", "WTDA", "WTDB", "WVWA", "WVWB", "WMPA", "WPGA" },
