...
public abstract class KeybindInput {
    ...
    public static implicit operator KeybindInput(Keys key) {
        return new KeyboardInput(key);
    }

    public static implicit operator KeybindInput(ModifierKeys key) {
        return new ModifierInput(key);
    }

    public static implicit operator KeybindInput(MouseKeys key) {
        return new MouseInput(key);
    }

    public virtual bool InputEquality(KeybindInput other) {
