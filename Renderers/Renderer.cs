...
namespace Cornifer.Renderers {
    public abstract class Renderer {
        ...
        public virtual Matrix Transform => Matrix.Multiply(Matrix.CreateTranslation(-Position.X, -Position.Y, 0),
            Matrix.CreateScale(Scale));

        public virtual Matrix InverseTransform => Matrix.Multiply(Matrix.CreateScale(1 / Scale),
        ...
        public abstract void DrawTexture(Texture2D texture, Vector2 worldPos, Rectangle? source = null,
            Vector2? worldSize = null, Color? color = null, Vector2? scaleOverride = null);
    }
}